...
export interface ApiAfficheAffiche extends Struct.SingleTypeSchema {
  collectionName: 'affiches';
  info: {
    singularName: 'affiche';
    pluralName: 'affiches';
    displayName: 'Affiche Page';
    description: '';
  };
  options: {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['shared.affiche-item']> &
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    blocks: Schema.Attribute.DynamicZone<['shared.main-item']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    mainPicture: Schema.Attribute.Media<'images' | 'videos'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiTeamPageTeamPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    colleagues: Schema.Attribute.Component<'shared.team-item', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
